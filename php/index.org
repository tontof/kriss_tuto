...
#+END_NOTES
** GET
#+INCLUDE: "./examples/form_get.php" src xml
...
#+END_NOTES
** POST
#+INCLUDE: "./examples/form_post.php" src xml
...
#+INCLUDE: "./examples/form_multiple_post.php" src xml
...
#+INCLUDE: "./examples/form_multiple_button.php" src xml
...
#+INCLUDE: "./examples/form_post_file.php" src xml

   [[./examples/form.php?filename=form_post_file][exemple]]

#+INCLUDE: "./examples/form_post_files.php" src xml
...
#+INCLUDE: "./examples/session_login.php" src c
...
#+INCLUDE: "./examples/session_form.php" src xml
...
#+INCLUDE: "./examples/session_menu.php" src xml
...
#+INCLUDE: "./examples/session_info.php" src c
...
#+INCLUDE: "./examples/session_public.php" src xml
...
#+INCLUDE: "./examples/session_protected.php" src xml
...
#+INCLUDE: "./examples/pdo_exception.php" src c

   [[./examples/pdo_exception.php][exemple]]

#+INCLUDE: "./examples/pdo_try.php" src c
...
#+INCLUDE: "./examples/pdo_close.php" src c
...
#+INCLUDE: "./examples/pdo_error.php" src c
...
#+INCLUDE: "./examples/pdo_create.php" src c
...
#+INCLUDE: "./examples/pdo_insert.php" src c
...
#+INCLUDE: "./examples/pdo_select.php" src c
...
#+INCLUDE: "./examples/pdo_select_fetch.php" src c
...
#+INCLUDE: "./examples/pdo_update.php" src c
...
#+INCLUDE: "./examples/pdo_delete.php" src c
...
#+INCLUDE: "./examples/pdo_prepare.php" src c
...
** PDO : fermeture du curseur
   ...
   #+INCLUDE: "./examples/pdo_close_cursor.php" src c
