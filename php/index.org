...
#+INCLUDE: "./examples/session_form.php" src html

** Utilisation des sessions - 3

#+INCLUDE: "./examples/session_menu.php" src html

** Utilisation des sessions - 4

#+INCLUDE: "./examples/session_info.php" src html

** Utilisation des sessions - 5

#+INCLUDE: "./examples/session_public.php" src html

** Utilisation des sessions - 6

#+INCLUDE: "./examples/session_protected.php" src html
...
#+INCLUDE: "./examples/pdo_exception.php" src php

   [[./examples/pdo_exception.php][exemple]]

#+INCLUDE: "./examples/pdo_try.php" src php
...
#+INCLUDE: "./examples/pdo_close.php" src php
...
#+INCLUDE: "./examples/pdo_error.php" src php
...
#+INCLUDE: "./examples/pdo_create.php" src php

** PDO : insertion

#+INCLUDE: "./examples/pdo_insert.php" src php
   
   [[./examples/pdo_insert.php][exemple]]

** PDO : sélection

#+INCLUDE: "./examples/pdo_select.php" src php
   
   [[./examples/pdo_select.php][exemple]]

** PDO : parcours des données

#+INCLUDE: "./examples/pdo_select_fetch.php" src php

   [[./examples/pdo_select_fetch.php][exemple]]

** PDO : mise à jour

#+INCLUDE: "./examples/pdo_update.php" src php
   
   [[./examples/pdo_update.php][exemple]]

** PDO : suppression

#+INCLUDE: "./examples/pdo_delete.php" src php
   
   [[./examples/pdo_delete.php][exemple]]

** PDO : préparation

#+INCLUDE: "./examples/pdo_prepare.php" src php
   
   [[./examples/pdo_prepare.php][exemple]]

** PDO : fermeture du curseur

#+INCLUDE: "./examples/pdo_close_cursor.php" src php
